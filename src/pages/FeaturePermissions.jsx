...
export default function FeaturePermissions() {
  ...
  const loadFeatures = async () => {
    try {
      ...
      } else if (!selectedFeatureId && list.length > 0) {
        setSelectedFeatureId(String(list[0].id));
      }
    } catch (err) {
  ...
  const savePermission = async (event) => {
    ...
    const featureId = String(selectedFeatureId || form.featureId || "").trim();
  ...
  const filteredPermissions = useMemo(() => {
    ...
    return permissions.filter((permission) => {
      ...
      return (
        (key.includes(query) || name.includes(query) || description.includes(query)) &&
  ...
  return (
    <div className="feature-permissions-page">
      ...
      {success && (
        <div className="fp-success-message" role="status">
          {success}
        </div>
      )}
      ...
      <section className="fp-info-card">
        <div className="fp-info-top">
          ...
          <div className="fp-mode-chip">
            {isEditing ? `Editing: ${form.key}` : "Creating New Permission"}
          </div>
        </div>
        ...
        <div className="fp-form-grid">
          <div className="fp-field">
            ...
            <div className="fp-select-wrap">
              <select
                ...
                disabled={featuresLoading || isEditing}
              >
            ...
            <small>
              {selectedFeature
                ...
                : "Select the feature this permission belongs to."}
            </small>
          </div>
          ...
          <div className="fp-field">
            ...
            <input
              ...
              disabled={isEditing}
            />
            <small>Unique key for the permission. Use UPPERCASE with underscores.</small>
          </div>
          ...
          <div className="fp-field">
            ...
            />
            <small>Display name for the permission.</small>
          </div>
          ...
          <div className="fp-field fp-description-field">
            ...
            />
            <small>Explain what this permission allows users to do.</small>
          </div>
        </div>
        ...
        <div className="fp-form-actions">
          ...
          >
            ...
            {saving ? "Saving..." : isEditing ? "Update Permission" : "Save Permission"}
          </button>
        </div>
      </section>
        ...
        <div className="fp-table-wrap">
          <table className="fp-table">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan="5" className="fp-empty-cell">
                    Loading permissions...
                  </td>
                </tr>
              ) : !selectedFeatureId ? (
                <tr>
                  <td colSpan="5" className="fp-empty-cell">
                    Select a feature to view permissions.
                  </td>
                </tr>
                ...
                filteredPermissions.map((permission) => {
                  ...
                  return (
                    <tr key={id}>
                      <td>{permission.permissionKey || permission.key || "-"}</td>
                      <td>{permission.name || "-"}</td>
                      <td className="fp-description-cell">
                        {permission.description || "-"}
                      </td>
                      <td>
                        <span className={`fp-status-pill ${status.toLowerCase()}`}>
                          <b />
                      ...
                      <td>
                        <div className="fp-row-actions">
                          ...
                          <button
                            ...
                            disabled={saving || deletingId !== null}
                            aria-label="Duplicate permission"
                          >
